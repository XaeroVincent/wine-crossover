...
PKGNAMESUFFIX=	-crossover${FLAVOR:N${FLAVORS:[1]}:C/.+/-${FLAVOR}/}

MAINTAINER=	tmp386@live.com
COMMENT=	Microsoft Windows compatibility environment with Crossover 26.0.3 patches
...
USE_GITHUB=	yes
GH_ACCOUNT=	wine-mirror
GH_PROJECT=	wine
GH_TAGNAME=	wine-11.0
...
CONFLICTS_INSTALL=	wine wine-devel wine-xaero-devel
